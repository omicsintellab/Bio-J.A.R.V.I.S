...
def get_integer_tax_id(tax_id_from_user):
    """
    Ensures that the taxid will be an int
    """
    while True:
        user_input = input(tax_id_from_user)
        try:
            value = int(user_input)
            return value
        except ValueError:
            print("Invalid input. Please enter a valid TaxID.")

def greetings_to_user():
    return 'Thank you for using Bio-J.A.R.V.I.S \nTry your TaxID or This One: 10376 (human gammaherpesvirus 4)'

def farwell_to_user():
    return 'Thank you for using Bio-J.A.R.V.I.S! See you later!'
